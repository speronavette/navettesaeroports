          ...
          <div className="bg-white rounded-t-lg shadow-lg p-8 border-b-4 border-purple-600">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-2">
                Merci pour votre demande de navette aéroport depuis <span className="font-semibold">La Louvière/Charleroi</span>, <span className="font-semibold">{data.firstName} {data.lastName}</span>.
              </p>
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  ...
                  <div className="space-y-3">
                    {data.tripType === TRIP_TYPES.ROUND_TRIP ? (
                      <>
                        <p className="flex justify-between">
                          <span className="text-gray-500">Navette aller (La Louvière/Charleroi → {data.airport}):</span>
                          <span className="font-medium">{pricePerTrip.toFixed(2)}€</span>
                        </p>
                        <p className="flex justify-between">
                          <span className="text-gray-500">Navette retour ({data.airport} → La Louvière/Charleroi):</span>
                          <span className="font-medium">{pricePerTrip.toFixed(2)}€</span>
                        </p>
                      </>
                    ) : (
                      <p className="flex justify-between">
                        <span className="text-gray-500">Navette {data.tripType === TRIP_TYPES.OUTBOUND ? `aller (La Louvière/Charleroi → ${data.airport})` : `retour (${data.airport} → La Louvière/Charleroi)`}:</span>
                        <span className="font-medium">{pricePerTrip.toFixed(2)}€</span>
                      </p>
                    )}
            ...
            {(data.tripType === TRIP_TYPES.OUTBOUND || data.tripType === TRIP_TYPES.ROUND_TRIP) && (
              <div className="p-8 border-b border-gray-200">
                <h2 className="text-2xl font-bold text-purple-700 mb-6">
                  ...
                  Navette aller - La Louvière/Charleroi vers {data.airport}
                </h2>
            ...
            {(data.tripType === TRIP_TYPES.INBOUND || data.tripType === TRIP_TYPES.ROUND_TRIP) && (
              <div className="p-8 border-b border-gray-200">
                <h2 className="text-2xl font-bold text-purple-700 mb-6">
                  ...
                  Navette retour - {data.airport} vers La Louvière/Charleroi
                </h2>
            ...
            <div className="p-8 bg-purple-50">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p>Notre chauffeur de La Louvière vous contactera un jour avant votre départ pour confirmer les détails de votre navette.</p>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <p>Le paiement de votre navette aéroport s'effectue directement auprès du chauffeur par espèces ou carte de crédit.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-b-lg shadow-lg p-8">
            <div className="text-center">
              <p className="mb-6 text-gray-600">
                Notre équipe familiale de La Louvière a reçu votre demande de navette aéroport et vous contactera bientôt pour confirmer les détails.

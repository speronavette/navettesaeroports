  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <link rel="canonical" href="https://www.votre-domaine.be/" />
        ...
        <div className="container-custom">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h2 className="text-2xl font-semibold text-center mb-6">Réservez votre navette aéroport</h2>
              <PriceCalculator />
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-first lg:order-last">
              <img 
                src="/assets/images/van-navette-aeroport.webp" 
                srcSet="/assets/images/van-navette-aeroport-sm.webp 640w, /assets/images/van-navette-aeroport-md.webp 1024w, /assets/images/van-navette-aeroport.webp 1920w"
                sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 40vw"
                alt="Van navette aéroport 8 places pour transport vers Bruxelles Zaventem et Brussels South" 
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="h-52 bg-cover bg-center" style={{ backgroundImage: "url('/assets/images/aeroport-bruxelles.webp')" }}></div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="h-52 bg-cover bg-center" style={{ backgroundImage: "url('/assets/images/aeroport-charleroi.webp')" }}></div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="h-52 bg-cover bg-center" style={{ backgroundImage: "url('/assets/images/gare-midi.webp')" }}></div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="h-52 bg-cover bg-center" style={{ backgroundImage: "url('/assets/images/aeroport-luxembourg.webp')" }}></div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="h-52 bg-cover bg-center" style={{ backgroundImage: "url('/assets/images/aeroport-amsterdam.webp')" }}></div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="h-52 bg-cover bg-center" style={{ backgroundImage: "url('/assets/images/aeroport-paris.webp')" }}></div>
              <div className="p-6">
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-10">
              <Link to="/contact-navette-aeroport" className="btn-outline px-6 py-3">
